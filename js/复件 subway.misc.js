...
//            window.console.log("mouse X=" + lastX + "Y=" + lastY);	
	    ...
	    function MouseClick(x,y){
	    	...
	    	{
	    		var zoomFac=1.3;
	    		canvastop=-(line_y-l)*zoomFac*40-890;
			 		canvasleft=-(line_x-t)*zoomFac*40-580;
	         ...
	         curStation=station;
	    		...
	    		//站点圆圈放大
	    		new_stationAnim(new_ctx);
	    	}	  	    	  	
	    	});
	    }
	  function new_stationAnim(new_ctx){
           ...
           new_ctx.arc(curStation.x, curStation.y, stationRadius, 0, Math.PI * 2, true);
           new_ctx.closePath();
           new_ctx.stroke();
           new_ctx.fill();
		       lineWidth += 1;
